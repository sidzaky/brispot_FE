<h3 class="box-title" align="center">List Data Agen Brilink </h3>
   ...
   <button class="btn btn-primary waves-effect waves-light btn-sm" style="float:right;" onclick="getform('setting_content')" type="button"><i class="fa fa-Left"></i> Kembali</button>
    ...
    <table class="table table-striped table-bordered" id="table_form" width="100%">
        ...
        <tbody>
          <?php 
            ...
            echo '<tr>';
            echo '<td> Jumlah Data Brilink</td>';
            echo '<td id="data_brilink" align="right">'. $data_brilink[0]['agen_brilink'] .'</td>';
            echo '<td align="right"><button class="btn btn-warning waves-effect waves-light btn-sm" style="float:right;" onclick="showform(\'brilink\')" type="button"><i class="fa fa-plus"></i> edit</button></td>';
            echo '</tr>';
          ?>
        </tbody>
    </table>
    ...
    <script>
        ...
        function showform(i=null){
            setdata=i;
            document.getElementById("changeform").innerHTML="Jumlah agen brilink";
            document.getElementById("value_data").value=document.getElementById("data_brilink").innerHTML;
            $("#modal").show();
        }
        ...
        function sendform(){
            ...
            var notif   = "Update Jumlah Data brilink Berhasil ";
            var address = "./setting/up_brilink";
            sendajax(data, address, null, notif, null);
            document.getElementById("data_brilink").innerHTML=$('#value_data').val();
            $("#modal").hide();
        }
