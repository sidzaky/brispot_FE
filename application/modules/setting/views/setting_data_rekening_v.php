<h3 class="box-title" align="center">List Jumlah Data Simpanan dan Pinjaman </h3>
   ...
   <button class="btn btn-primary waves-effect waves-light btn-sm" style="float:right;" onclick="getform('setting_content')" type="button"><i class="fa fa-Left"></i> Kembali</button>
    ...
    <table class="table table-striped table-bordered" id="table_form" width="100%">
        ...
        <tbody>
          <?php 
            ...
            echo '<tr>';
            echo '<td> Jumlah Data Rekening Simpanan</td>';
            echo '<td id="data_rekening_simpanan" align="right">'. $data_rekening[0]['jumlah_rekening_simpanan'] .'</td>';
            ...
            echo '</tr>';
            echo '<tr>';
            echo '<td> Jumlah Data Rekening Pinjaman</td>';
            echo '<td id="data_rekening_pinjaman" align="right">'. $data_rekening[0]['jumlah_rekening_pinjaman'] .'</td>';
    ...
    <script>
        ...
        function showform(i=null){
            setdata=i;
            document.getElementById("changeform").innerHTML="Jumlah Data Rekening "+i;
            document.getElementById("value_data").value=document.getElementById("data_rekening_"+i).innerHTML;
            $("#modal").show();
        }
        ...
        function sendform(){
            ...
            var notif   = "Update Jumlah Data Rekening "+setdata+" Berhasil ";
            var address = "./setting/up_jumlah_data_rekening";
            sendajax(data, address, null, notif, null);
            document.getElementById("data_rekening_"+setdata).innerHTML=$('#value_data').val();
            $("#modal").hide();
        }
