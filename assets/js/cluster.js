  ...
  $.ajax({
    ...
    success: function (smsg) {
      ...
      document.getElementById("hsuk").innerHTML =
        ...
        msg +
        "</label>";
      document.getElementById("chker").innerHTML =
        '<label for="thedata" class="col-sm-8 control-label">' +
        msg +
        "</label>";
...
function getform(i = null) {
  ...
  if (i != null) {
    ...
    document.getElementById("kode_uker").value =
      "<?php echo $this->session->userdata('kode_uker'); ?>";
      ...
      baseHTML.html(`
          <div class="row">
            <div class="col-md-12 info-heading">
              ...
              <h4>${info.hasil_produk} - ${
        info.kelompok_jumlah_anggota
      } anggota</h4>
